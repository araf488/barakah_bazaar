...
- Starts as Postgres `tsvector` inside the Catalog module; this module exists once that stops being enough.
- Target: Typesense or Meilisearch, populated by a queued indexer that follows product writes.
- Bangla and English must both be searchable, including transliterated queries.
